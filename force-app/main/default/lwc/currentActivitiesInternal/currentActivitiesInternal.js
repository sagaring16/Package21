...
import CUSTOMER_SUPPORT from '@salesforce/label/c.Customer_Support';
import { loadStyle } from 'lightning/platformResourceLoader';

export default class CurrentActivitiesInternal extends LightningElement {
    @api uniqueName;
    @api title;
    @track carddata = [];
    technicalSupportPage = CUSTOMER_SUPPORT;
